...
# Source your theme file (assuming you save the themes as oeda_themes.R)
source("oeda_themes.R")

# Setup for dual output
darksvglite <- function(file, width = 7, height = 7, pointsize = 12, ...) {
  svglite(file = file, width = width, height = height, 
          pointsize = pointsize, bg = "#414042")
}
