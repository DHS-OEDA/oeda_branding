...
::: {.callout-important title="ggplot2 is not working with dark mode toggles"}

I'm trying to get this working without bringing in the `quartoExtra` package, but having difficulty. The solution may be to just
use conditional logic and two versions of the plot, but that is excessive effort for the researcher.
